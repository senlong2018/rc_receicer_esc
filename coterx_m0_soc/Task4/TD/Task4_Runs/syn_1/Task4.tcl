...
set rc [catch {
  optimize_rtl
  report_area -file Task4_rtl.area
  export_db {Task4_rtl.db}
} RESULT]
if {$rc} {
  step_error opt_rtl
  return -code error $RESULT
...
set rc [catch {
  optimize_gate -maparea Task4_gate.area
  legalize_phy_inst
  export_db {Task4_gate.db}
} RESULT]
if {$rc} {
  step_error opt_gate
  return -code error $RESULT

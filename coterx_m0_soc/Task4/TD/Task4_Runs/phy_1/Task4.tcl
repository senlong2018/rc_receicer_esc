...
set rc [catch {
  open_project {Task4.prj} -phy
  import_device eagle_20.db -package EG4X20BG256
  import_db {../syn_1/Task4_gate.db}
  place
  export_db {Task4_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file Task4_phy.area
  export_db {Task4_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid Task4_inst.bid
  bitgen -bit "Task4.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
